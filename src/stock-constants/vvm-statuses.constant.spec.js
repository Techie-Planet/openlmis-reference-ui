...
describe('VVM_STATUS', function() {
    ...
    describe('getDisplayName', function() {
        ...
        it('should get display name for STAGE_3 status', function() {
            expect(VVM_STATUS.$getDisplayName(VVM_STATUS.STAGE_3)).toBe('stockConstants.stage3');
        });

        it('should get display name for STAGE_4 status', function() {
            expect(VVM_STATUS.$getDisplayName(VVM_STATUS.STAGE_4)).toBe('stockConstants.stage4');
        });
    });
});
