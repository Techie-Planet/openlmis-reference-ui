...
(function() {
    ...
    function routes($stateProvider, STOCKMANAGEMENT_RIGHTS, ADJUSTMENT_TYPE) {
        $stateProvider.state('openlmis.stockmanagement.programtransfer', {
            isOffline: true,
            url: '/program-transfer',
            label: 'stockProgramTransfer.programTransfer',
            priority: 2,
            showInNavigation: true,
            views: {
                '@openlmis': {
                    controller: 'StockAdjustmentProgramTransferController',
                    controllerAs: 'vm',
                    templateUrl: 'stock-program-transfer/stock-program-transfer.html'
                }
            },
