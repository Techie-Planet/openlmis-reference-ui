...
(function() {
    ...
    /**
     * @ngdoc controller
     * @name stock-adjustment.controller:StockAdjustmentProgramTransferController
     *
     * @description
    ...
    angular
        ...
        .controller('StockAdjustmentProgramTransferController', controller);
    ...
    function controller(facility, programs, adjustmentType, $state, offlineService, localStorageService,
        ...
        vm.startProgramTransfer = function() {
            $state.go('openlmis.stockmanagement.' + adjustmentType.state + '.creation', {
                programId: vm.programTransferFrom.id,
                programToId: vm.programTransferTo.id,
                program: vm.programTransferFrom,
                programTo: vm.programTransferTo,
                facility: facility
            });
        };
    }
